...
/// Modular carriers
	...
	class CarrierRigKBT_01_SYNIXE_CO: V_CarrierRigKBT_01_base_F {
		...
		{
			"\s\synixe_equipment\addons\branded_equipment\data\CarrierRigKBT_01_SYNIXE_CO.paa"
		};
	};
...
/// MMAC
	...
	class synixe_mgp_vest_mmac_light_synixe: synixe_mgp_vest_mmac_light_base {
		...
		hiddenSelectionsTextures[]=
		{
			"\s\synixe_equipment\addons\branded_equipment\data\v_mmac_synixe.paa",
...
/// Cap
	...
	class synixe_mgp_h_cap_synixe: synixe_mgp_h_cap_base {
		...
		hiddenSelectionsTextures[]=
		{
			"\s\synixe_equipment\addons\branded_equipment\data\h_cap_gry_synixe.paa",
	...
	class synixe_mgp_h_cap_synixe_b: synixe_mgp_h_cap_base {
		...
		hiddenSelectionsTextures[]=
		{
			"\s\synixe_equipment\addons\branded_equipment\data\h_cap_blk_synixe.paa",
			"\milgp_headgear\variants\h_gear_01_blk_co.paa"
		};
	};
